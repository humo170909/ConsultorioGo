...
<div style="padding:1.5rem var(--content-px)">
    <p style="font-size:var(--text-sm);color:var(--text-secondary);margin-bottom:1.25rem">
        ...
        /* ── Inicializar botones de signo (el formulario ya está en DOM) ── */
        _initSignButtons(document.getElementById('examSection'));
                ...
                <div class="eye-section-body">
                    <div class="eye-field form-group">
                        ...
                        <div class="sign-field">
                            <div class="sign-btns" role="group" aria-label="Signo esfera OD">
                                <button type="button" class="sign-btn" data-sign="+" data-target="eOdEsf" aria-label="Positivo">+</button>
                                <button type="button" class="sign-btn" data-sign="-" data-target="eOdEsf" aria-label="Negativo">−</button>
                            </div>
                            <input id="eOdEsf" class="form-input" type="text" inputmode="decimal" autocomplete="off" maxlength="7" value="${_fmtFieldVal(v('od_esfera'))}" placeholder="+0.00">
                        </div>
                    </div>
                    <div class="eye-field form-group">
                        <label class="form-label">Cilindro</label>
                        <div class="sign-field">
                            <div class="sign-btns" role="group" aria-label="Signo cilindro OD">
                                <button type="button" class="sign-btn" data-sign="+" data-target="eOdCil" aria-label="Positivo">+</button>
                                <button type="button" class="sign-btn" data-sign="-" data-target="eOdCil" aria-label="Negativo">−</button>
                            </div>
                            <input id="eOdCil" class="form-input" type="text" inputmode="decimal" autocomplete="off" maxlength="7" value="${_fmtFieldVal(v('od_cilindro'))}" placeholder="−0.00">
                        </div>
                    </div>
                    <div class="eye-field form-group">
            ...
            <div class="eye-section oi" style="margin-bottom:0.875rem">
                ...
                <div class="eye-section-body">
                    <div class="eye-field form-group">
                        <label class="form-label">Esfera</label>
                        <div class="sign-field">
                            <div class="sign-btns" role="group" aria-label="Signo esfera OI">
                                <button type="button" class="sign-btn" data-sign="+" data-target="eOiEsf" aria-label="Positivo">+</button>
                                <button type="button" class="sign-btn" data-sign="-" data-target="eOiEsf" aria-label="Negativo">−</button>
                            </div>
                            <input id="eOiEsf" class="form-input" type="text" inputmode="decimal" autocomplete="off" maxlength="7" value="${_fmtFieldVal(v('oi_esfera'))}" placeholder="+0.00">
                        </div>
                    </div>
                    <div class="eye-field form-group">
                        <label class="form-label">Cilindro</label>
                        <div class="sign-field">
                            <div class="sign-btns" role="group" aria-label="Signo cilindro OI">
                                <button type="button" class="sign-btn" data-sign="+" data-target="eOiCil" aria-label="Positivo">+</button>
                                <button type="button" class="sign-btn" data-sign="-" data-target="eOiCil" aria-label="Negativo">−</button>
                            </div>
                            <input id="eOiCil" class="form-input" type="text" inputmode="decimal" autocomplete="off" maxlength="7" value="${_fmtFieldVal(v('oi_cilindro'))}" placeholder="−0.00">
                        </div>
                    </div>
                    <div class="eye-field form-group">
                        <label class="form-label">Eje (°)</label>
                ...
                <div class="form-section-body">
                    <div class="form-grid-2">
                        ...
                        <div class="form-group">
                            ...
                            <input id="eAdd" class="form-input" type="text" inputmode="decimal" autocomplete="off" maxlength="5" value="${_fmtFieldVal(v('adicion'))}" placeholder="+1.50">
                        </div>
                    </div>
                    <div class="form-group">
    ...
    /* ============================================================
       SIGN BUTTONS — Selección de signo +/- para campos de graduación
       ============================================================ */
    function _initSignButtons(root) {
        const ctx = root || document;

        function _syncBtnState(input) {
            const val = input.value.trim();
            const container = input.closest('.sign-field');
            if (!container) return;
            container.querySelectorAll('.sign-btn').forEach(b => {
                b.classList.remove('is-active-plus', 'is-active-minus');
            });
            if (val.startsWith('+')) {
                container.querySelector('[data-sign="+"]')?.classList.add('is-active-plus');
            } else if (val.startsWith('-')) {
                container.querySelector('[data-sign="-"]')?.classList.add('is-active-minus');
            }
        }

        ctx.querySelectorAll('.sign-btn').forEach(btn => {
        ...
        ctx.querySelectorAll('.sign-field input').forEach(input => {
            input.addEventListener('input', () => _syncBtnState(input));
            ...
            input.addEventListener('keydown', (e) => {
                ...
                if ((e.key === '+' || e.key === '-') && e.target.selectionStart === 0) return;
                e.preventDefault();
            });
