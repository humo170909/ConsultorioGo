...
(async function initLogin() {
    ...
    function _mensajeError(err) {
        /* Extraer texto del error en distintos formatos de Supabase */
        const raw = [
            err?.message,
        ...
        console.log('[Login] Raw error string para diagnóstico:', raw);
        ...
        if (raw.includes('invalid login credentials') ||
            ...
            return `
                <strong>Credenciales incorrectas (400)</strong><br>
                Posibles causas:<br>
                &bull; El usuario <em>${_safeEmail()}</em> no existe en Supabase Auth.<br>
                &bull; La contraseña es incorrecta.<br>
                &bull; El email tiene mayúsculas o espacios extra.<br>
                <a href="setup.html" style="color:#1d4ed8;font-weight:600">
                    → Crear usuario administrador aquí
                </a>
            `;
        }
